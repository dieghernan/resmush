...
#> See results in directory /tmp/Rtmpdld0eQ/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/Rtmpdld0eQ/extimg/example_resmush.jpg
#> → /tmp/Rtmpdld0eQ/extimg/example_resmush.png
...
#> See results in directories /tmp/Rtmpdld0eQ/extimg,
#> /tmp/Rtmpdld0eQ/extimg/top1/nested, /tmp/Rtmpdld0eQ/extimg/top1, and
#> /tmp/Rtmpdld0eQ/extimg/top2.
