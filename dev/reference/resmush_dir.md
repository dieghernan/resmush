...
#> See results in directory /tmp/Rtmp5FfgPq/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/Rtmp5FfgPq/extimg/example_resmush.jpg
#> → /tmp/Rtmp5FfgPq/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [813ms] | ETA:  1s (2/5 files)
...
#> See results in directories /tmp/Rtmp5FfgPq/extimg,
#> /tmp/Rtmp5FfgPq/extimg/top1/nested, /tmp/Rtmp5FfgPq/extimg/top1, and
#> /tmp/Rtmp5FfgPq/extimg/top2.
