...
#> See results in directory /tmp/RtmpjOHNSA/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpjOHNSA/extimg/example_resmush.jpg
#> → /tmp/RtmpjOHNSA/extimg/example_resmush.png
...
#> See results in directories /tmp/RtmpjOHNSA/extimg,
#> /tmp/RtmpjOHNSA/extimg/top1/nested, /tmp/RtmpjOHNSA/extimg/top1, and
#> /tmp/RtmpjOHNSA/extimg/top2.
