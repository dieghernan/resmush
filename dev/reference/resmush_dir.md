...
#> See results in directory /tmp/RtmpuJT5fJ/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpuJT5fJ/extimg/example_resmush.jpg
#> → /tmp/RtmpuJT5fJ/extimg/example_resmush.png
...
#> See results in directories /tmp/RtmpuJT5fJ/extimg,
#> /tmp/RtmpuJT5fJ/extimg/top1/nested, /tmp/RtmpuJT5fJ/extimg/top1, and
#> /tmp/RtmpuJT5fJ/extimg/top2.
