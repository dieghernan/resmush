# Contributing to resmush

This guide explains how to propose a change to **resmush**. Review the
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("dieghernan/resmush", fork = TRUE)`.
...
Please note that the **resmush** project is released with a [Contributor
Code of
Conduct](https://dieghernan.github.io/resmush/dev/CODE_OF_CONDUCT.md).
