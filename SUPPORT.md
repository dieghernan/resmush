...
Thanks for using resmush! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/dieghernan/resmush/issues/new).
...
requests](https://github.com/dieghernan/resmush/issues) to make sure the
