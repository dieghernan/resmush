...
#> Saved results in directory /tmp/RtmpMgnwri/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpMgnwri/extimg/example_resmush.jpg
#> → /tmp/RtmpMgnwri/extimg/example_resmush.png

# Optimize files recursively.
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Optimizing 5 files.
#> 🕐  reSmushing | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [1.5s] | ETA:  2s (2/5 f…
#> 🕑  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■□□□□□□   80% [4.2s] | ETA:  1s (4/5 f…
#> 🕑  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [5s] | ETA:  0s (5/5 fil…
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 5 files, 401.7 Kb total.
#> ✔ Optimized 5 files: size is now 173.5 Kb (was 401.7 Kb). Saved 228.2 Kb (56.81%).
#> Saved results in directories /tmp/RtmpMgnwri/extimg,
#> /tmp/RtmpMgnwri/extimg/top1/nested, /tmp/RtmpMgnwri/extimg/top1, and
#> /tmp/RtmpMgnwri/extimg/top2.
