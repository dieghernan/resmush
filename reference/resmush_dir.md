...
#> See results in directory /tmp/RtmpYATGrb/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpYATGrb/extimg/example_resmush.jpg
#> → /tmp/RtmpYATGrb/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■□□□□□□   80% [1.9s] | ETA:  0s (4/5 files)
...
#> See results in directories /tmp/RtmpYATGrb/extimg,
#> /tmp/RtmpYATGrb/extimg/top1/nested, /tmp/RtmpYATGrb/extimg/top1, and
#> /tmp/RtmpYATGrb/extimg/top2.
