...
#> Saved results in directory /tmp/Rtmp5rr97z/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/Rtmp5rr97z/extimg/example_resmush.jpg
#> → /tmp/Rtmp5rr97z/extimg/example_resmush.png
...
#> Saved results in directories /tmp/Rtmp5rr97z/extimg,
#> /tmp/Rtmp5rr97z/extimg/top1/nested, /tmp/Rtmp5rr97z/extimg/top1, and
#> /tmp/Rtmp5rr97z/extimg/top2.
