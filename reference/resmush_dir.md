...
#> See results in directory /tmp/RtmpZt3YBf/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpZt3YBf/extimg/example_resmush.jpg
#> → /tmp/RtmpZt3YBf/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [978ms] | ETA:  1s (2/5 files)
...
#> See results in directories /tmp/RtmpZt3YBf/extimg,
#> /tmp/RtmpZt3YBf/extimg/top1/nested, /tmp/RtmpZt3YBf/extimg/top1, and
#> /tmp/RtmpZt3YBf/extimg/top2.
