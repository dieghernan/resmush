...
#> See results in directory /tmp/RtmpbqLOhd/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpbqLOhd/extimg/example_resmush.jpg
#> → /tmp/RtmpbqLOhd/extimg/example_resmush.png
...
#> 🕑  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [4.9s] | ETA:  0s (5/5 files)
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 5 files with size 401.7 Kb
#> ✔ Success for 5 files: Size now is 173.5 Kb (was 401.7 Kb). Saved 228.2 Kb (56.81%).
#> See results in directories /tmp/RtmpbqLOhd/extimg,
#> /tmp/RtmpbqLOhd/extimg/top1/nested, /tmp/RtmpbqLOhd/extimg/top1, and
#> /tmp/RtmpbqLOhd/extimg/top2.
