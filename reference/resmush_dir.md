...
#> Saved results in directory /tmp/RtmpdMCZZJ/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpdMCZZJ/extimg/example_resmush.jpg
#> → /tmp/RtmpdMCZZJ/extimg/example_resmush.png

# Optimize files recursively.
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Optimizing 5 files.
#> 🕐  reSmushing | ■■■■■■■■■■■■■■■■■■■□□□□□□□□□□□□   60% [1.7s] | ETA:  1s (3/5 f…
#> 🕐  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [2.8s] | ETA:  0s (5/5 f…
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 5 files, 401.7 Kb total.
#> ✔ Optimized 5 files: size is now 173.5 Kb (was 401.7 Kb). Saved 228.2 Kb (56.81%).
#> Saved results in directories /tmp/RtmpdMCZZJ/extimg,
#> /tmp/RtmpdMCZZJ/extimg/top1/nested, /tmp/RtmpdMCZZJ/extimg/top1, and
#> /tmp/RtmpdMCZZJ/extimg/top2.
