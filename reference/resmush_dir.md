...
#> Saved results in directory /tmp/Rtmp7FR69Y/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/Rtmp7FR69Y/extimg/example_resmush.jpg
#> → /tmp/Rtmp7FR69Y/extimg/example_resmush.png

# Recursive.
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Optimizing 5 files.
#> 🕐  reSmushing | ■■■■■■■□□□□□□□□□□□□□□□□□□□□□□□□   20% [1ms] | ETA:  0s (1/5 fi…
#> 🕑  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■□□□□□□   80% [2.3s] | ETA:  1s (4/5 f…
...
#> Saved results in directories /tmp/Rtmp7FR69Y/extimg,
#> /tmp/Rtmp7FR69Y/extimg/top1/nested, /tmp/Rtmp7FR69Y/extimg/top1, and
#> /tmp/Rtmp7FR69Y/extimg/top2.
