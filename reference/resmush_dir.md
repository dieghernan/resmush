...
#> See results in directory /tmp/Rtmp6Z5ucv/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/Rtmp6Z5ucv/extimg/example_resmush.jpg
#> → /tmp/Rtmp6Z5ucv/extimg/example_resmush.png
...
#> See results in directories /tmp/Rtmp6Z5ucv/extimg,
#> /tmp/Rtmp6Z5ucv/extimg/top1/nested, /tmp/Rtmp6Z5ucv/extimg/top1, and
#> /tmp/Rtmp6Z5ucv/extimg/top2.
