...
#> See results in directory /tmp/RtmpJdXFEn/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpJdXFEn/extimg/example_resmush.jpg
#> → /tmp/RtmpJdXFEn/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■□□□□□□□□□□□□□□□□□□□□□□□□   20% [1ms] | ETA:  0s (1/5 files)
#> 🕑  Go! | ■■■■■■■■■■■■■■■■■■■□□□□□□□□□□□□   60% [2.2s] | ETA:  1s (3/5 files)
...
#> See results in directories /tmp/RtmpJdXFEn/extimg,
#> /tmp/RtmpJdXFEn/extimg/top1/nested, /tmp/RtmpJdXFEn/extimg/top1, and
#> /tmp/RtmpJdXFEn/extimg/top2.
