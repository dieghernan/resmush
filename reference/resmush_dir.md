...
#> Saved results in directory /tmp/RtmpUDIA3e/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpUDIA3e/extimg/example_resmush.jpg
#> → /tmp/RtmpUDIA3e/extimg/example_resmush.png

# Optimize files recursively.
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Optimizing 5 files.
#> 🕐  reSmushing | ■■■■■■■■■■■■■■■■■■■□□□□□□□□□□□□   60% [1.9s] | ETA:  1s (3/5 f…
...
#> Saved results in directories /tmp/RtmpUDIA3e/extimg,
#> /tmp/RtmpUDIA3e/extimg/top1/nested, /tmp/RtmpUDIA3e/extimg/top1, and
#> /tmp/RtmpUDIA3e/extimg/top2.
