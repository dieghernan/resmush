...
#> See results in directory /tmp/RtmpMdSInR/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpMdSInR/extimg/example_resmush.jpg
#> → /tmp/RtmpMdSInR/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [1s] | ETA:  2s (2/5 files)
...
#> See results in directories /tmp/RtmpMdSInR/extimg,
#> /tmp/RtmpMdSInR/extimg/top1/nested, /tmp/RtmpMdSInR/extimg/top1, and
#> /tmp/RtmpMdSInR/extimg/top2.
