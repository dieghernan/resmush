...
#> Saved results in directory /tmp/Rtmp77alWX/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/Rtmp77alWX/extimg/example_resmush.jpg
#> → /tmp/Rtmp77alWX/extimg/example_resmush.png
...
#> 🕐  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [2.6s] | ETA:  0s (5/5 f…
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 5 files, 401.7 Kb total.
#> ✔ Optimized 5 files: size is now 173.5 Kb (was 401.7 Kb). Saved 228.2 Kb (56.81%).
#> Saved results in directories /tmp/Rtmp77alWX/extimg,
#> /tmp/Rtmp77alWX/extimg/top1/nested, /tmp/Rtmp77alWX/extimg/top1, and
#> /tmp/Rtmp77alWX/extimg/top2.
