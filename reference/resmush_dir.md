...
#> Saved results in directory /tmp/RtmpEJI0eM/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpEJI0eM/extimg/example_resmush.jpg
#> → /tmp/RtmpEJI0eM/extimg/example_resmush.png
...
#> Saved results in directories /tmp/RtmpEJI0eM/extimg,
#> /tmp/RtmpEJI0eM/extimg/top1/nested, /tmp/RtmpEJI0eM/extimg/top1, and
#> /tmp/RtmpEJI0eM/extimg/top2.
