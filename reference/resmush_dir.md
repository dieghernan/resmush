...
#> Saved results in directory /tmp/RtmpNMaXeq/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpNMaXeq/extimg/example_resmush.jpg
#> → /tmp/RtmpNMaXeq/extimg/example_resmush.png

# Optimize files recursively.
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Optimizing 5 files.
#> 🕐  reSmushing | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [957ms] | ETA:  1s (2/5 …
...
#> Saved results in directories /tmp/RtmpNMaXeq/extimg,
#> /tmp/RtmpNMaXeq/extimg/top1/nested, /tmp/RtmpNMaXeq/extimg/top1, and
#> /tmp/RtmpNMaXeq/extimg/top2.
