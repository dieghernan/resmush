...
#> See results in directory /tmp/RtmpWejlQt/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpWejlQt/extimg/example_resmush.jpg
#> → /tmp/RtmpWejlQt/extimg/example_resmush.png
...
#> See results in directories /tmp/RtmpWejlQt/extimg,
#> /tmp/RtmpWejlQt/extimg/top1/nested, /tmp/RtmpWejlQt/extimg/top1, and
#> /tmp/RtmpWejlQt/extimg/top2.
