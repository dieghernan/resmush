...
#> Saved results in directory /tmp/RtmpjtESNG/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpjtESNG/extimg/example_resmush.jpg
#> → /tmp/RtmpjtESNG/extimg/example_resmush.png
...
#> Saved results in directories /tmp/RtmpjtESNG/extimg,
#> /tmp/RtmpjtESNG/extimg/top1/nested, /tmp/RtmpjtESNG/extimg/top1, and
#> /tmp/RtmpjtESNG/extimg/top2.
