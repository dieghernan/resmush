...
#> See results in directory /tmp/RtmpetpgEz/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpetpgEz/extimg/example_resmush.jpg
#> → /tmp/RtmpetpgEz/extimg/example_resmush.png
...
#> 🕑  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [4.1s] | ETA:  0s (5/5 files)
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 5 files with size 401.7 Kb
#> ✔ Success for 5 files: Size now is 173.5 Kb (was 401.7 Kb). Saved 228.2 Kb (56.81%).
#> See results in directories /tmp/RtmpetpgEz/extimg,
#> /tmp/RtmpetpgEz/extimg/top1/nested, /tmp/RtmpetpgEz/extimg/top1, and
#> /tmp/RtmpetpgEz/extimg/top2.
