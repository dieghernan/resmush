...
#> Saved results in directory /tmp/RtmpgkaSjf/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Removing 2 files:
#> → /tmp/RtmpgkaSjf/extimg/example_resmush.jpg
#> → /tmp/RtmpgkaSjf/extimg/example_resmush.png
...
#> Saved results in directories /tmp/RtmpgkaSjf/extimg,
#> /tmp/RtmpgkaSjf/extimg/top1/nested, /tmp/RtmpgkaSjf/extimg/top1, and
#> /tmp/RtmpgkaSjf/extimg/top2.
