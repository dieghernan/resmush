...
#> See results in directory /tmp/RtmpoI3JRB/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpoI3JRB/extimg/example_resmush.jpg
#> → /tmp/RtmpoI3JRB/extimg/example_resmush.png
...
#> See results in directories /tmp/RtmpoI3JRB/extimg,
#> /tmp/RtmpoI3JRB/extimg/top1/nested, /tmp/RtmpoI3JRB/extimg/top1, and
#> /tmp/RtmpoI3JRB/extimg/top2.
