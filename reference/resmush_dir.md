...
#> See results in directory /tmp/Rtmpr6aZCT/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/Rtmpr6aZCT/extimg/example_resmush.jpg
#> → /tmp/Rtmpr6aZCT/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [928ms] | ETA:  1s (2/5 files)
...
#> See results in directories /tmp/Rtmpr6aZCT/extimg,
#> /tmp/Rtmpr6aZCT/extimg/top1/nested, /tmp/Rtmpr6aZCT/extimg/top1, and
#> /tmp/Rtmpr6aZCT/extimg/top2.
