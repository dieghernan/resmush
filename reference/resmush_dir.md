...
#> See results in directory /tmp/Rtmp5bSoJx/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/Rtmp5bSoJx/extimg/example_resmush.jpg
#> → /tmp/Rtmp5bSoJx/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■□□□□□□□□□□□□□□□□□□□□□□□□   20% [1ms] | ETA:  0s (1/5 files)
#> 🕑  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■□□□□□□   80% [3s] | ETA:  1s (4/5 files)
...
#> See results in directories /tmp/Rtmp5bSoJx/extimg,
#> /tmp/Rtmp5bSoJx/extimg/top1/nested, /tmp/Rtmp5bSoJx/extimg/top1, and
#> /tmp/Rtmp5bSoJx/extimg/top2.
