...
#> See results in directory /tmp/RtmpkLuo1O/extimg.
resmush_clean_dir(dest_folder)
#> ℹ Would remove 2 files:
#> → /tmp/RtmpkLuo1O/extimg/example_resmush.jpg
#> → /tmp/RtmpkLuo1O/extimg/example_resmush.png

# Recursive
summary <- resmush_dir(dest_folder, recursive = TRUE)
#> ℹ Resmushing 5 files
#> 🕐  Go! | ■■■■■■■■■■■■■□□□□□□□□□□□□□□□□□□   40% [535ms] | ETA:  1s (2/5 files)
...
#> See results in directories /tmp/RtmpkLuo1O/extimg,
#> /tmp/RtmpkLuo1O/extimg/top1/nested, /tmp/RtmpkLuo1O/extimg/top1, and
#> /tmp/RtmpkLuo1O/extimg/top2.
