...
#> Saved result in directory /tmp/Rtmp2oDTaZ.
...
#> 🕐  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [885ms] | ETA:  0s (2/2 files)
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 2 files, total size 340.2 Kb.
#> ✔ Optimized 2 files: Size is now 153.8 Kb (was 340.2 Kb). Saved 186.4 Kb (54.79%).
#> Saved results in directory /tmp/Rtmp2oDTaZ.

# The invisible data frame contains the same information.
summary
#>                                src_img
#> 1  /tmp/Rtmp2oDTaZ/file1aa084b37c1.png
#> 2 /tmp/Rtmp2oDTaZ/file1aa07caabddb.jpg
#>                                       dest_img src_size dest_size
#> 1  /tmp/Rtmp2oDTaZ/file1aa084b37c1_resmush.png 239.9 Kb   70.7 Kb
#> 2 /tmp/Rtmp2oDTaZ/file1aa07caabddb_resmush.jpg 100.4 Kb   83.2 Kb
