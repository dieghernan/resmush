...
#> Saved result in directory /tmp/RtmpjDImkV.
...
#> 🕐  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [946ms] | ETA:  0s (2/2 …
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 2 files, 340.2 Kb total.
#> ✔ Optimized 2 files: size is now 153.8 Kb (was 340.2 Kb). Saved 186.4 Kb (54.79%).
#> Saved results in directory /tmp/RtmpjDImkV.

# Inspect the returned optimization summary.
summary
#>                                src_img
#> 1 /tmp/RtmpjDImkV/file1a8f2087ff4c.png
#> 2 /tmp/RtmpjDImkV/file1a8f1e8e4a54.jpg
#>                                       dest_img src_size dest_size
#> 1 /tmp/RtmpjDImkV/file1a8f2087ff4c_resmush.png 239.9 Kb   70.7 Kb
#> 2 /tmp/RtmpjDImkV/file1a8f1e8e4a54_resmush.jpg 100.4 Kb   83.2 Kb
