...
#> See result in directory /tmp/RtmpkLuo1O.
...
#> 🕐  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [660ms] | ETA:  0s (2/2 files)
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 2 files with size 340.2 Kb
#> ✔ Success for 2 files: Size now is 153.8 Kb (was 340.2 Kb). Saved 186.4 Kb (54.79%).
#> See results in directory /tmp/RtmpkLuo1O.

# Similar info in an (invisible) data frame as a result
summary
#>                                src_img
#> 1 /tmp/RtmpkLuo1O/file1b1433b5e23e.png
#> 2 /tmp/RtmpkLuo1O/file1b142e04637b.jpg
#>                                       dest_img src_size dest_size
#> 1 /tmp/RtmpkLuo1O/file1b1433b5e23e_resmush.png 239.9 Kb   70.7 Kb
#> 2 /tmp/RtmpkLuo1O/file1b142e04637b_resmush.jpg 100.4 Kb   83.2 Kb
