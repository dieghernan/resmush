...
#> Saved result in directory /tmp/Rtmp5rr97z.
...
#> 🕐  reSmushing | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [1s] | ETA:  0s (2/2 fil…
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 2 files, 340.2 Kb total.
#> ✔ Optimized 2 files: size is now 153.8 Kb (was 340.2 Kb). Saved 186.4 Kb (54.79%).
#> Saved results in directory /tmp/Rtmp5rr97z.

# Inspect the returned optimization summary.
summary
#>                                src_img
#> 1 /tmp/Rtmp5rr97z/file1b2d4c3487ae.png
#> 2 /tmp/Rtmp5rr97z/file1b2d3073a46f.jpg
#>                                       dest_img src_size dest_size
#> 1 /tmp/Rtmp5rr97z/file1b2d4c3487ae_resmush.png 239.9 Kb   70.7 Kb
#> 2 /tmp/Rtmp5rr97z/file1b2d3073a46f_resmush.jpg 100.4 Kb   83.2 Kb
