...
#> Saved result in directory /tmp/Rtmp0E80cN.
...
#> ●∙∙ Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [923ms] | ETA:  0s (2/2 files)
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 2 files, total size 340.2 Kb.
#> ✔ Optimized 2 files: Size is now 153.8 Kb (was 340.2 Kb). Saved 186.4 Kb (54.79%).
#> Saved results in directory /tmp/Rtmp0E80cN.

# The invisible data frame contains the same information.
summary
#>                                src_img
#> 1 /tmp/Rtmp0E80cN/file1baa1392c7c0.png
#> 2 /tmp/Rtmp0E80cN/file1baa52745958.jpg
#>                                       dest_img src_size dest_size
#> 1 /tmp/Rtmp0E80cN/file1baa1392c7c0_resmush.png 239.9 Kb   70.7 Kb
#> 2 /tmp/Rtmp0E80cN/file1baa52745958_resmush.jpg 100.4 Kb   83.2 Kb
