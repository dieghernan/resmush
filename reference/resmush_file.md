...
#> See result in directory /tmp/RtmpoI3JRB.
...
#> 🕐  Go! | ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% [913ms] | ETA:  0s (2/2 files)
#> 
#> ══ resmush summary ═════════════════════════════════════════════════════════════
#> ℹ Input: 2 files with size 340.2 Kb
#> ✔ Success for 2 files: Size now is 153.8 Kb (was 340.2 Kb). Saved 186.4 Kb (54.79%).
#> See results in directory /tmp/RtmpoI3JRB.

# Similar info in an (invisible) data frame as a result
summary
#>                                src_img
#> 1 /tmp/RtmpoI3JRB/file1d78455204b4.png
#> 2 /tmp/RtmpoI3JRB/file1d7837857c9f.jpg
#>                                       dest_img src_size dest_size
#> 1 /tmp/RtmpoI3JRB/file1d78455204b4_resmush.png 239.9 Kb   70.7 Kb
#> 2 /tmp/RtmpoI3JRB/file1d7837857c9f_resmush.jpg 100.4 Kb   83.2 Kb
