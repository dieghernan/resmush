...
minimal setup, including support for online images and formats such as GIF,
BMP and TIFF. Packages such as **tinyimg** may be a better fit for fully
local workflows focused on PNG / JPEG optimization and fine-grained control
over compression settings.
