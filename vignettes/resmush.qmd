...
Original image @fig-orig, 178.7 KB, and optimized image @fig-new, 45 KB
(74.8% compression). Click to enlarge.
:::
...
Comparison of image optimization alternatives for **R** packages.
:::
...
Supported formats for **R** packages.
:::
