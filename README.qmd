...
<figcaption>Figure 2: Low quality image due to a high compression
rate.</figcaption>
:::
...
cat(
  paste0(
    "<p class=\"caption\">Table 1: <strong>R</strong> packages: ",
...
cat(
  paste0(
    ...
    "<strong>R</strong> packages: Supported formats.</p>"
  )
)
```
