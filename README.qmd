...
**resmush** is an **R** package that allows users to optimize and compress
...
<figcaption>Figure 1: Original picture <em>(a)</em>: 178.7 KB; optimized
picture <em>(b)</em>: 45 KB (compression: 74.8%). Click to enlarge.</figcaption>
:::
