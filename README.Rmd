...
**reSmush.it** is free of charge, but its team is planning to offer more serves
as well as extend the service to support other types of image files. If you
enjoy this API (as I do), you can consider supporting them.

::: {.text-center .mb-4}
[![Support reSmush.it on
Ko-fi](man/figures/ko-fi-resmush.png){width="296"}](https://ko-fi.com/E1E51PW00)
:::
...
[here](https://yihui.org/en/2024/01/bye-rstudio/)). Yihui has developed some of
the most amazing packages for **R** such as **knitr**, **markdown**,
**blogdown**, and **bookdown**.

::: {.text-center .mb-4}
[![Sponsor
Yihui](man/figures/sponsor.png){width="175"}](https://github.com/sponsors/yihui)
:::
:::
